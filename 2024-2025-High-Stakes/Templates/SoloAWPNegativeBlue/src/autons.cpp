...
void regular(){
  ...
  chassis.set_swing_exit_conditions(1, 300, 800);
  chassis.drive_distance(20.5, 37.5+d);
  ...
  chassis.left_swing_to_angle(59+d);
  chassis.drive_distance(13.5, 59+d);
  wait(0.4, seconds);
  //Intake.stop();
  chassis.set_drive_constants(11, 5, 0, 10, 0);
  chassis.drive_distance(-17.9, 60+d);
  ...
  //Intake.spin(forward);
  chassis.drive_distance(20.3, 110+d);
  wait(1.6, seconds);
