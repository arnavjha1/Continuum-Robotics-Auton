...
void ArmUp(){
  chassis.left_swing_to_angle(1.5);
}
void task1(){
...
void regular(){
  ...
  Intake.spin(forward);
  chassis.left_swing_to_angle(129.5+d);
  chassis.right_swing_to_angle(38+d);
  chassis.set_swing_exit_conditions(1, 300, 800);
  chassis.drive_distance(18, 37.5+d); //16.7
  ...
  chassis.drive_distance(-10.2, 45.5+d);
  chassis.left_swing_to_angle(63+d);
  chassis.drive_distance(14.5, 59+d); //14
  wait(0.4, seconds);
  //Intake.stop();
  chassis.set_drive_constants(11, 5, 0, 10, 0);
  chassis.drive_distance(-14.2, 60+d);
  ...
  //Intake.spin(forward);
  chassis.drive_distance(18.3, 110+d); //17.3
  wait(0.1, seconds);
  chassis.drive_distance(5, 110+d);
  wait(1.6, seconds);
  chassis.set_drive_constants(11, 100, 0, 10, 0);
  Intake.stop();
  chassis.drive_distance(-32, 110+d);
}
