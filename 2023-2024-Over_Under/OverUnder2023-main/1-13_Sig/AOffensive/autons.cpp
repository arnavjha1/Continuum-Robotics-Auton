...
void drive_test(){
  ...
  chassis.drive_distance(30, 0, 6, 6);
  Catapult.stop();
  Catapult.setVelocity(100, percent);
  chassis.drive_distance(-6);

  Intake.stop();
  chassis.set_turn_exit_conditions(1, 300, 1200);
  ...
  chassis.drive_distance(-6);
  chassis.set_turn_exit_conditions(1.5, 300, 800);
  chassis.turn_to_angle(57.5);
  chassis.set_turn_exit_conditions(1.5, 300, 600);
  Intake.spin(reverse);
  ...
  chassis.set_turn_exit_conditions(1.5, 300, 1000);
  chassis.turn_to_angle(90); 
  Intake.spin(reverse);
  ...
  chassis.set_drive_exit_conditions(1, 0, 3000);
