...
void usercontrol(void) {
    ...
    if (!isShooting) {
      controller(primary).ButtonR2.pressed(shootCatapult);
    }
    ...
    controller(primary).ButtonUp.pressed(toggleIntake);
    controller(primary).ButtonLeft.pressed(toggleWings);

    controller(primary).ButtonB.pressed(doMatchloads);
    controller(primary).ButtonB.released(stopMatchloads);
