...
void auton(void) {
  ...
  myblockfunction_PTurn_head(40.0);
  myblockfunction_PStraight_dist_head_velo(50.0, 40.0, 80.0);
  ...
  message2.broadcast();
  Drivetrain.turnFor(right, 90 - Drivetrain.rotation(), degrees, false);
  wait(1.0, seconds);
  myblockfunction_PStraight_dist_head_velo(30.0, 90.0, 100.0);
