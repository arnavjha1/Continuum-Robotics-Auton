...
// User defined function
void myblockfunction_PTurn_head(double myblockfunction_PTurn_head__head, double myblockfunction_PTurn_head__left, double myblockfunction_PTurn_head__right);
// User defined function
...
// User defined function
void myblockfunction_PTurn_head(double myblockfunction_PTurn_head__head, double myblockfunction_PTurn_head__left = true, double myblockfunction_PTurn_head__right = true) {
...
void auton(void) {
  ...
  IntakePneu.set(true);
  WingPneu.set(false);
  myblockfunction_PStraight_dist_head_velo(15.0, -45.0, 100.0); //60
  WingPneu.set(true);
  myblockfunction_PStraight_dist_head_velo(-15.0, -45.0, -100.0);
  WingPneu.set(false);
  myblockfunction_PStraight_dist_head_velo(10.0, -45.0, 100.0); //60
  Drivetrain.turnFor(right, 40-Drivetrain.rotation(), degrees);
  myblockfunction_PStraight_dist_head_velo(41.0, 40.0, 100.0); //80
  Drivetrain.turnFor(left, Drivetrain.rotation()+90, degrees);
  IntakePneu.set(false);
  Intake.spin(reverse);
  ...
  Drivetrain.stop();
  wait(20, msec);
  myblockfunction_PStraight_dist_head_velo(5.0, 0.0, 100.0); //50
  message2.broadcast();
  Drivetrain.turnFor(right, 120 - Drivetrain.rotation(), degrees, false);
  wait(1.0, seconds);
  Drivetrain.stop();
  myblockfunction_PStraight_dist_head_velo(25.0, 90.0, 100.0);
  Drivetrain.setStopping(brake);
